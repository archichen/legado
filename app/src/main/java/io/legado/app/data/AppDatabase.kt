...
import io.legado.app.data.dao.CorrectionTaskDao
import io.legado.app.data.dao.CookieDao
import io.legado.app.data.dao.DictRuleDao
import io.legado.app.data.dao.HttpTTSDao
import io.legado.app.data.dao.KeyboardAssistsDao
import io.legado.app.data.dao.LLMProviderDao
...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        LLMProvider::class, ChatMessage::class, BookEmbedding::class, CorrectionTask::class],
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val correctionTaskDao: CorrectionTaskDao
